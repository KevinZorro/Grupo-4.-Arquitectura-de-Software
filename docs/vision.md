...
**Supuesto A-02 — Cobro en línea del copago.** El copago de la cita virtual se paga en línea: el paciente espera hasta
tener el cupo retenido y el enlace de pago, y el resultado del cobro llega al sistema por webhook, de forma asíncrona.
Agrega la pasarela de pagos como octavo actor del sistema.
...
el proveedor de video y la pasarela de pagos: el caso los nombra en sus demandas de calidad. Son ocho actores, y el
diagrama de contexto de la sección 3 tiene dieciséis flechas.
...
| Pasarela de pagos | Resultado del cobro del copago por webhook (A-02) | Monto y referencia opaca de la transacción. **Nunca especialidad ni motivo** |
...
**La pasarela de pagos (supuesto A-02) agrega la octava flecha de salida y la octava de entrada.** El sistema le entrega
solo el monto del copago y una referencia opaca de la transacción, sin especialidad ni motivo; la pasarela responde con
el resultado del cobro por webhook. Con ello el diagrama queda en ocho actores y dieciséis flechas.
